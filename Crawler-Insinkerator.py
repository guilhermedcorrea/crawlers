...
class EcommerceSpider(object):
    ...
    def get_links(self):
        self.links = ['https://www.insinkerator.com.br/product/torneira-3n1-com-sistema-de-%C3%A1gua-quente ', 'https://www.insinkerator.com.br/product/evolution-200-disposer ', 'https://www.insinkerator.com.br/product/evolution-100-disposer ', 'https://www.insinkerator.com.br/product/triturador-modelo-66 ', 'https://www.insinkerator.com.br/product/triturador-modelo-56 ',
                      'https://www.insinkerator.com.br/product/triturador-modelo-46 ', 'https://www.insinkerator.com.br/product/hc3300-sistema-de-%C3%A1gua-quente-e-fria ', 'https://www.insinkerator.com.br/product/hc1100-hot-and-cold-water-tap ', 'https://www.insinkerator.com.br/product/torneira-3n1-com-sistema-de-%C3%A1gua-quente']
    ...
    def extract_item(self, html, link):
        EspList = {}
        try:
            nome = html.xpath("//div[@class='clearfix']/h1")[0].text
        except IndexError as e:
            nome = "Not Found"

        try:
            desc = html.xpath("//div[@class='content']/div/p//text()")[0]
        except IndexError as e:
            desc = "Not Found"

        EspList = dict(Nome=nome, Descrição=desc)
        att = html.xpath("//div[@id='tabs-1']//text()")
        ...
        imgs = html.xpath("//div[@class='main-image']//a/@href")
        imgcont = 1

        for x in imgs:
            EspList["Imagem "+str(imgcont)] = x
            imgcont += 1

        downloads = html.xpath("//div[@id='tabs-2']//a/@href")
        dcont = 1
        for x in downloads:
            EspList["Download "+str(dcont)] = x
            dcont += 1
