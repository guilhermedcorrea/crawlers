...
class Organizer(object):
    def __init__(self, key):
        ...
        self.Cods = ['Código', 'Gerais - Referência', ' • Referência',
                     'Referência', ' Referência', 'Modelo' ,'Cod_Secundario', 'CodRef', 'Codref', 'Código de barras', 'EAN', 'Ean', 'Código De Barras']
...
class EcommerceSpider(object):
    ...
    def crawl(self):
        ...
        for Dep in self.Depnames:
            ...
            if(len(self.Cnames) > 1):
                ...
                self.Clinks[Dep] = self.Departments[Dep]
                self.get_links(session, Dep)
    ...
    def get_links(self, session, cname):
        ...
        try:
            ...
            next_page = self.Clinks[cname] + next_page
            print(next_page)
        except IndexError as e:
            next_page= None                
            print(str(next_page) + "1")
        while next_page:
